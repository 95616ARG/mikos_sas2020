...
def parse_arguments(argv):
    ...
    analysis.add_argument('--memopt',
                          dest='memopt',
                          help='Enable memory optimization (MIKOS)',
                          action='store_true',
                          default=False)
...
def main(argv):
    ...
    if opt.memopt:
        opt.output_db = "mikos-" + os.path.basename(opt.file) + ".db"
    else:
        opt.output_db = "ikos-" + os.path.basename(opt.file) + ".db"
